    ...
    >
      ...
      >
        <motion.p variants={animation.fadeBottomAnimation} custom={0.6}>
          ...
          <br />
          Это мой самый первый клиент, занимаются бухгалтерскими услугами. В этом году делал для них новый сайт. Они со
          мной уже 7 лет. <br />
          На сайте есть выбор города, для каждого из которых на сервере создана отдельная папка. В папках есть файлы с
          переменными где храняться все контактные данные, цены и название города в разных падежах. Благодаря этим
          переменным все блоки на сайте универсальные и в разных городах используются только ссылки на них, а вся
          уникальная информация берется из переменных.
        </motion.p>
      </motion.div>
    </ProjectsPopup>
  )
