    ...
    >
      ...
      >
        <motion.p variants={animation.fadeBottomAnimation} custom={0.6}>
          ...
          <br />
          Это мой самый первый клиент, сотрудничаем почти 7 лет. В этом году делал для них новый сайт. <br />
          На сайте есть выбор города, для каждого из которых на сервере создана отдельная папка. В папках есть файлы с
          переменными, где хранятся все контактные данные, цены и название города в разных падежах. Благодаря этим
