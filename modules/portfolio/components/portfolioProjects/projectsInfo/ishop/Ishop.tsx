    ...
    >
      ...
      >
        <motion.p variants={animation.fadeBottomAnimation} custom={0.6}>
          ...
          Яндексе и Google по городу Красноярску. Можно практически любой коммерческий запрос проверить по айфонам, сайт
          будет на первой странице, а часто в топ 5. Два раза я делал редизайн, плюс регулярно, что-то улучшаю и
          дорабатываю.
        </motion.p>
      </motion.div>
    </ProjectsPopup>
