    ...
    >
      ...
      >
        <motion.p variants={animation.fadeBottomAnimation} custom={0.6}>
          Сайт по продаже кликфальца. Создавался весной 2023 года. Дизайн разрабатывал я сам. Одной из важных задач было
          простое взаимодействие с сайтом, чтобы клиент мог самостоятельно менять и добавлять информацию. Для этого было
          создано большое количество произвольный полей, благодаря которым в админке очень удобно всем управлять. Плюс я
          записал видеоинструкции в которых рассказал как работать с сайтом.
        </motion.p>
      </motion.div>
    </ProjectsPopup>
  )
